...
public static class WavUtility
{
    ...
    //保存文件并返回bytes
    public static byte[] FromAudioClip(AudioClip audioClip, string filepath)
    {
        ...
        //  Debug.Log(DateTime.UtcNow.ToString("HHmmss"));
        //Debug.Log(fileName);
        stream.Dispose();
    ...
    //public static byte[] TestFromAudioClip(AudioClip clip)
    //{
